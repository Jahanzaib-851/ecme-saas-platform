...
async function fetchProfile(): Promise<ProfileSchema> {
    const resp = await apiGetProfile<any>()
...
const SettingsProfile = () => {
    ...
    const { data, mutate } = useSWR('/auth/profile', fetchProfile, {
    ...
    const onSubmit = async (values: ProfileSchema) => {
        try {
            ...
            // Sync name and avatar into the global Zustand session
            setUser({
            ...
            toast.push(
                <Notification type="success" title="Profile updated successfully" />,
                { placement: 'top-end' },
            )
        } catch (err: any) {
            toast.push(
